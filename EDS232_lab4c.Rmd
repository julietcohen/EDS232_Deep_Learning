...
The standard neural net for my 2 species sample returned a higher accuracy than for the convolutional neural net for my 2 species sample, but the loss rate was lower for the convolutional neural net. I would choose to use the standard convolutional neural net for this analysis.
